...
if __name__ == '__main__':
    ...
    print('train_face_data_size', train_face_data_size, 'train_non_face_data_size', train_non_face_data_size)
    print('total', train_non_face_data_size + train_non_face_data_size)
    ...
    print('face_test_data_size', face_test_data_size, 'non_test_face_data_size', non_test_face_data_size)
    print('total', face_test_data_size + non_test_face_data_size)
